      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4 group">
            <div className="logo-container p-2 relative w-24 h-16">
              <Image
                className="rounded-lg border-2 border-[#f8f8f2]/20 hover:border-[#2c3e50] transition-all duration-300 hover:scale-105 object-cover"
